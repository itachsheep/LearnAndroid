package com.tao.weexsearch.widget;
 ...
 */
public class WeexMaterialHeader extends View implements PtrUIHandler {
    private WeexMaterialProgressDrawable mDrawable;
    ...
    public WeexMaterialHeader(Context context) {
        super(context);
        initView();
    }

    public WeexMaterialHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public WeexMaterialHeader(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        mDrawable = new WeexMaterialProgressDrawable(getContext(), this);

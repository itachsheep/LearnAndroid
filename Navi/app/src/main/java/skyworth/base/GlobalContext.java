...
import skyworth.protocol.IVoiceControl;

public class GlobalContext {

    private static Context sContext;

    // TODO: 2017/9/12 thread secure
    ...
    // TODO: 2017/9/12 weakreference when gc scaned, release
    ...
    public static BaseActivity getTopActivity() {
        for (int i = sActivities.size() - 1; i >= 0; i--) {
            WeakReference<BaseActivity> weakReference = sActivities.get(i);

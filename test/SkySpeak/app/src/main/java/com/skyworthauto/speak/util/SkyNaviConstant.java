...
public class SkyNaviConstant {

    public static final String ACTION_SKY_NAVI_BROADCAST_RECV =
            "SKYWORTH_AUTONAVI_STANDARD_BROADCAST_RECV";
    public static final String ACTION_SKY_NAVI_BROADCAST_SEND =
            "SKYWORTH_AUTONAVI_STANDARD_BROADCAST_SEND";
    ...
    public static final String EXTRA_IS_SHOW_PREVIEW = "EXTRA_IS_SHOW";
    public static final int ENTER_PREVIEW = 0;
    ...
    public static final int NORTH_UPWARDS = 1;
    ...
    public static final String EXTRA_NAVI_ROUTE_PREFER = "NAVI_ROUTE_PREFER";
    public static final int AVOID_COST = 1;
    public static final int PRIORITY_SPEED_COST_DISTANCE = 2;
    public static final int AVOID_HIGHSPEED = 3;
    public static final int AVOID_CONGESTION = 4;
    public static final int AVOID_HIGHTSPEED_COST = 5;
    public static final int AVOID_HIGHSPEED_CONGESTION = 6;
    public static final int PRIORITY_HIGHSPEED = 20;

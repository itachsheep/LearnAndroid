...
import navi_.navi.BaseActivity;
...
public class SingleRouteCalculateActivity extends BaseActivity {
    ...
    public void onInitNaviSuccess() {
        ...
        LogUtils.i("SingleRouteCalculateActivity.onInitNaviSuccess");
        mAMapNavi.calculateDriveRoute(sList, eList, mWayPointList, strategy);
    }

    @Override
    public void onCalculateRouteSuccess(int[] ints) {
        LogUtils.i("SingleRouteCalculateActivity.onCalculateRouteSuccess");

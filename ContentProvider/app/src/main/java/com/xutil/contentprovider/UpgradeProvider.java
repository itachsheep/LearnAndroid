...
public class UpgradeProvider extends ContentProvider {
	...
	public boolean onCreate() {
		LogUtil.log("UpgradeProvider onCreate");
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		LogUtil.log("UpgradeProvider query uri: "+uri);
	...
	public String getType(Uri uri) {
		// TODO Auto-generated method stub
		LogUtil.log("UpgradeProvider getType uri: "+uri);
	     switch (sURIMatcher.match(uri)) {
         case DEVICEINFO:
	...
	public int delete(Uri uri, String selection, String[] selectionArgs) {
		LogUtil.log("UpgradeProvider delete uri:"+uri);
		// TODO Auto-generated method stub
		SQLiteDatabase db = mOpenHelper.getWritableDatabase();
        int count;
        switch (sURIMatcher.match(uri)) {
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		LogUtil.log("UpgradeProvider update uri:"+uri);
		// TODO Auto-generated method stub
		SQLiteDatabase db = mOpenHelper.getWritableDatabase();
        int count;
        switch (sURIMatcher.match(uri)) {
	...
	public int bulkInsert(Uri uri, ContentValues[] values) {
		LogUtil.log("UpgradeProvider bulkInsert uri: "+uri);
		SQLiteDatabase db = mOpenHelper.getWritableDatabase();
